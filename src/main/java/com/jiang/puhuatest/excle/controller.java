...
//
//import static com.example.word.SjTableRenderPolicy.log;
//
///**
// * @author JiangBing
...
//
//	public <PlanEntity> Object download(HttpServletResponse response, @RequestBody String[] ids) throws IOException {
//		List<PlanEntity> list = ExcelWriteTest.excelWrite(ids);
////		log.warn("获取数据:\n"+list);
